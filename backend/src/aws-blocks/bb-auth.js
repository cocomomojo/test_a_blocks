...
var Auth = /** @class */ (function () {
    function Auth(config) {
        this.config = config || {};
        this.userPoolId = (config === null || config === void 0 ? void 0 : config.userPoolId) || 'mock-user-pool';
        this.clientId = (config === null || config === void 0 ? void 0 : config.clientId) || 'mock-client-id';
    }
    Auth.prototype.signUp = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, { userId: "user-".concat(Date.now()) }];
            });
        });
    };
    Auth.prototype.signIn = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, { token: "token-".concat(Date.now()) }];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (token && token.startsWith('token-')) {
                    return [2 /*return*/, { userId: 'mock-user' }];
                }
