...
router.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name_1, userId, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                userId = "user_".concat(Date.now());
                return [4 /*yield*/, index_js_1.userTable.put({
                        userId: userId,
                        email: email,
                        name: name_1,
                        createdAt: Date.now(),
...
router.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, sessionId, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                ...
                token = Buffer.from("".concat(email, ":").concat(sessionId)).toString('base64');
                return [4 /*yield*/, index_js_1.sessionTable.put({
                        sessionId: sessionId,
                        email: email,
                        createdAt: Date.now(),
...
router.get('/verify', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decoded, _a, email, sessionId;
    var _b;
    return __generator(this, function (_c) {
        try {
            ...
            _a = decoded.split(':'), email = _a[0], sessionId = _a[1];
            res.json({
                valid: true,
                email: email,
                sessionId: sessionId,
